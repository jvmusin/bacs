...
public class SubmissionDto {
    ...
    public SubmissionDto(Submission sub) {
        ...
        this.verdict = sub.getResult().getVerdict();
        this.firstFailedTest = sub.getResult().getTestsPassed();
        this.usedMillis = sub.getResult().getTimeUsedMillis();
        this.usedKilobytes = sub.getResult().getMemoryUsedBytes();
